...
urlpatterns = [
	...
	path('event/<name_event>/delete/', views.delete_event, name='delete_event'), #delete l'événement
	...
	path('event/<name_event>/courses/<id_invite>/delete/', views.delete_products_to_event, name='delete_products_to_event'), #suppression des courses d'un participant
	path('event/<name_event>/courses/<id_invite>/update/', views.update_products_to_event, name='update_products_to_event'), #modification des course d'un participant
]